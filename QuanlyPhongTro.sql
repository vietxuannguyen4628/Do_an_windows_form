...
(2, 5, '2024-10-15', '2024-10-20', (60 - 20) * 3300),
(3, 5, '2024-10-20', '2024-10-25', (55 - 15) * 3300),
(4, 5, '2024-10-23', '2024-10-30', (65 - 25) * 3300),
(5, 5, '2024-10-22', '2024-10-29', (58 - 18) * 3300),
(6, 5, '2024-10-20', '2024-10-27', (62 - 22) * 3300),
(7, 5, '2024-10-21', '2024-10-28', (70 - 30) * 3300),
(8, 5, '2024-10-19', '2024-10-26', (60 - 20) * 3300),
(9, 5, '2024-10-18', '2024-10-25', (64 - 24) * 3300),

-- Dịch vụ nước (ThanhTien = (ChiSoMoi - ChiSoCu) * DonGia)
(1, 4, '2024-10-01', '2024-10-05', (10 - 5) * 10000),
(2, 4, '2024-10-15', '2024-10-20', (15 - 8) * 10000),
(3, 4, '2024-10-20', '2024-10-25', (18 - 10) * 10000),
(4, 4, '2024-10-23', '2024-10-30', (20 - 12) * 10000),
(5, 4, '2024-10-22', '2024-10-29', (16 - 9) * 10000),
(6, 4, '2024-10-20', '2024-10-27', (13 - 7) * 10000),
(7, 4, '2024-10-21', '2024-10-28', (12 - 6) * 10000),
(8, 4, '2024-10-19', '2024-10-26', (14 - 8) * 10000),
(9, 4, '2024-10-18', '2024-10-25', (18 - 10) * 10000),

-- Các dịch vụ khác (ChiSoMoi - ChiSoCu = 1)
(1, 1, '2024-10-01', '2024-10-05', (1 - 0) * 100000), -- Internet
(1, 2, '2024-10-01', '2024-10-05', (1 - 0) * 50000),  -- Rác
(2, 1, '2024-10-15', '2024-10-20', (1 - 0) * 100000), -- Internet
(2, 2, '2024-10-15', '2024-10-20', (1 - 0) * 50000),  -- Rác
(3, 1, '2024-10-20', '2024-10-25', (1 - 0) * 100000), -- Internet
(3, 2, '2024-10-20', '2024-10-25', (1 - 0) * 50000),  -- Rác
(4, 1, '2024-10-23', '2024-10-30', (1 - 0) * 100000), -- Internet
(4, 3, '2024-10-23', '2024-10-30', (1 - 0) * 200000), -- Giữ Xe
(5, 1, '2024-10-22', '2024-10-29', (1 - 0) * 100000), -- Internet
(5, 2, '2024-10-22', '2024-10-29', (1 - 0) * 50000),  -- Rác
(6, 1, '2024-10-20', '2024-10-27', (1 - 0) * 100000), -- Internet
(6, 3, '2024-10-20', '2024-10-27', (1 - 0) * 200000), -- Giữ Xe
(7, 1, '2024-10-21', '2024-10-28', (1 - 0) * 100000), -- Internet
(7, 2, '2024-10-21', '2024-10-28', (1 - 0) * 50000),  -- Rác
(8, 1, '2024-10-19', '2024-10-26', (1 - 0) * 100000), -- Internet
