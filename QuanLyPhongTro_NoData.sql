...
INSERT INTO [dbo].[PhieuThutien] (MaPTT, MaPTP, MaDV, TuNgay, DenNgay, ThanhTien)
VALUES
--cho phiếu thuê 1, dịch vụ internet
(1, 1, 1, '2024-01-01', '2024-02-01', 100000),
(2, 1, 1, '2024-02-01', '2024-03-01', 100000),
(3, 1, 1, '2024-03-01', '2024-04-01', 100000),
(4, 1, 1, '2024-04-01', '2024-05-01', 100000),
(5, 1, 1, '2024-05-01', '2024-06-01', 100000),
(6, 1, 1, '2024-06-01', '2024-07-01', 100000),



--cho phiếu thuê 1, dịch vụ rác
(12, 1, 2, '2024-01-01', '2024-02-01', 50000),
(13, 1, 2, '2024-02-01', '2024-03-01', 50000),
(14, 1, 2, '2024-03-01', '2024-04-01', 50000),
(15, 1, 2, '2024-04-01', '2024-05-01', 50000),
(16, 1, 2, '2024-05-01', '2024-06-01', 50000),
(17, 1, 2, '2024-06-01', '2024-07-01', 50000),


--cho phiếu thuê 1, dịch vụ gửi xe
(23, 1, 3, '2024-01-01', '2024-02-01', 20000),
(24, 1, 3, '2024-02-01', '2024-03-01', 20000),
(25, 1, 3, '2024-03-01', '2024-04-01', 20000),
(26, 1, 3, '2024-04-01', '2024-05-01', 20000),
(27, 1, 3, '2024-05-01', '2024-06-01', 20000),
(28, 1, 3, '2024-06-01', '2024-07-01', 20000),


--cho phiếu thuê 1, dịch vụ nước
(34, 1, 3, '2024-01-01', '2024-02-01', 50000), -- 5 m³ x 10000
(35, 1, 3, '2024-02-01', '2024-03-01', 30000), -- 3 m³ x 10000
(36, 1, 3, '2024-03-01', '2024-04-01', 70000), -- 7 m³ x 10000
(37, 1, 3, '2024-04-01', '2024-05-01', 40000), -- 4 m³ x 10000
(38, 1, 3, '2024-05-01', '2024-06-01', 60000), -- 6 m³ x 10000
(39, 1, 3, '2024-06-01', '2024-07-01', 20000), -- 2 m³ x 10000



--cho phiếu thuê 1, dịch vụ điện
(45, 1, 5, '2024-01-01', '2024-02-01', 132000), -- 40 kWh x 3300
(46, 1, 5, '2024-02-01', '2024-03-01', 231000), -- 70 kWh x 3300
(47, 1, 5, '2024-03-01', '2024-04-01', 165000), -- 50 kWh x 3300
(48, 1, 5, '2024-04-01', '2024-05-01', 297000), -- 90 kWh x 3300
(49, 1, 5, '2024-05-01', '2024-06-01', 198000), -- 60 kWh x 3300
(50, 1, 5, '2024-06-01', '2024-07-01', 264000), -- 80 kWh x 3300



--cho phiếu thuê 2, dịch vụ rác
(58, 2, 2, '2024-03-01', '2024-04-01', 20000),
(59, 2, 2, '2024-04-01', '2024-05-01', 20000),
(60, 2, 2, '2024-05-01', '2024-06-01', 20000),
(61, 2, 2, '2024-06-01', '2024-07-01', 20000),
(62, 2, 2, '2024-07-01', '2024-08-01', 20000),
(63, 2, 2, '2024-08-01', '2024-09-01', 20000),
(64, 2, 2, '2024-09-01', '2024-10-01', 20000),


--cho phiếu thuê 2, dịch vụ nước
(67, 2, 4, '2024-03-01', '2024-04-01', 40000),  -- 4 m³
(68, 2, 4, '2024-04-01', '2024-05-01', 50000),  -- 5 m³
(69, 2, 4, '2024-05-01', '2024-06-01', 20000),  -- 2 m³
(70, 2, 4, '2024-06-01', '2024-07-01', 30000),  -- 3 m³
(71, 2, 4, '2024-07-01', '2024-08-01', 40000),  -- 4 m³
(72, 2, 4, '2024-08-01', '2024-09-01', 30000),  -- 3 m³
(73, 2, 4, '2024-09-01', '2024-10-01', 50000),  -- 5 m³

--cho phiếu thuê 2, dịch vụ điện
(76, 2, 5, '2024-03-01', '2024-04-01', 33000),  -- 10 kWh
(77, 2, 5, '2024-04-01', '2024-05-01', 132000), -- 40 kWh
(78, 2, 5, '2024-05-01', '2024-06-01', 66000),  -- 20 kWh
(79, 2, 5, '2024-06-01', '2024-07-01', 99000),  -- 30 kWh
(80, 2, 5, '2024-07-01', '2024-08-01', 49500),  -- 15 kWh
(81, 2, 5, '2024-08-01', '2024-09-01', 110000), -- 33 kWh
(82, 2, 5, '2024-09-01', '2024-10-01', 132000), -- 40 kWh


-- cho phiếu thuê 3, dịch vụ rác
(85, 3, 2, '2024-07-25', '2024-08-25', 50000),
(86, 3, 2, '2024-08-25', '2024-09-25', 50000),
(87, 3, 2, '2024-09-25', '2024-10-25', 50000),


-- cho phiếu thuê 3, dịch vụ gửi xe
(90, 3, 3, '2024-07-25', '2024-08-25', 20000),
(91, 3, 3, '2024-08-25', '2024-09-25', 20000),
(92, 3, 3, '2024-09-25', '2024-10-25', 20000),


-- cho phiếu thuê 3, dịch vụ nước
(95, 3, 4, '2024-07-25', '2024-08-25', 100000),  -- 10 m³
(96, 3, 4, '2024-08-25', '2024-09-25', 130000),  -- 13 m³
(97, 3, 4, '2024-09-25', '2024-10-25', 120000),  -- 12 m³

-- cho phiếu thuê 3, dịch vụ điện
(100, 3, 5, '2024-07-25', '2024-08-25', 264000),   -- 80 kWh
(101, 3, 5, '2024-08-25', '2024-09-25', 399000),   -- 121 kWh (chỉ tính 100 kWh)
(102, 3, 5, '2024-09-25', '2024-10-25', 330000);   -- 100 kWh
