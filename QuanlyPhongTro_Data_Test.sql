...
INSERT INTO [dbo].[PhieuThuePhong] (MaPTP, MaPhong, MaKH, TienDacCoc, NgayThue) VALUES
(1, 101, 1, 100000, '2024-10-01'),  -- Ngày thuê 01/10/2024
(2, 103, 2, 200000, '2024-10-15'),  -- Ngày thuê 15/10/2024
(3, 104, 3, 150000, '2024-10-20'),  -- Ngày thuê 20/10/2024
(4, 106, 4, 300000, '2024-10-23'),  -- Ngày thuê 23/10/2024
(5, 107, 5, 250000, '2024-10-22'),  -- Ngày thuê 22/10/2024
(6, 109, 6, 270000, '2024-10-20'),  -- Ngày thuê 20/10/2024
(7, 110, 7, 200000, '2024-10-21'),  -- Ngày thuê 21/10/2024
(8, 112, 8, 220000, '2024-10-19'),  -- Ngày thuê 19/10/2024
(9, 113, 9, 280000, '2024-10-18');  -- Ngày thuê 18/10/2024
...
(1, 1, '2024-11-05'),  -- Ngày trả 05/10/2024
(2, 2, '2024-10-20'),  -- Ngày trả 20/10/2024
(3, 3, '2024-12-25');  -- Ngày trả 25/10/2024
...
INSERT INTO [dbo].[PhieuThutien] (MaPTT, MaPTP, MaDV, NgayThanhToan, ThanhTien) VALUES
-- Dịch vụ điện (ThanhTien = (ChiSoMoi - ChiSoCu) * DonGia)
(1, 1, 5, '2024-10-05', (50 - 10) * 3300),
(2, 2, 5, '2024-10-20', (60 - 20) * 3300),
(3, 3, 5, '2024-10-25', (55 - 15) * 3300),
(4, 4, 5, '2024-10-30', (65 - 25) * 3300),
(5, 5, 5, '2024-10-29', (58 - 18) * 3300),
(6, 6, 5, '2024-10-27', (62 - 22) * 3300),
(7, 7, 5, '2024-10-28', (70 - 30) * 3300),
(8, 8, 5, '2024-10-26', (60 - 20) * 3300),
(9, 9, 5, '2024-10-25', (64 - 24) * 3300),

-- Dịch vụ nước (ThanhTien = (ChiSoMoi - ChiSoCu) * DonGia)
(10, 1, 4, '2024-10-05', (10 - 5) * 10000),
(11, 2, 4, '2024-10-20', (15 - 8) * 10000),
(12, 3, 4, '2024-10-25', (18 - 10) * 10000),
(13, 4, 4, '2024-10-30', (20 - 12) * 10000),
(14, 5, 4, '2024-10-29', (16 - 9) * 10000),
(15, 6, 4, '2024-10-27', (13 - 7) * 10000),
(16, 7, 4, '2024-10-28', (12 - 6) * 10000),
(17, 8, 4, '2024-10-26', (14 - 8) * 10000),
(18, 9, 4, '2024-10-25', (18 - 10) * 10000),

-- Các dịch vụ khác (ChiSoMoi - ChiSoCu = 1)
(19, 1, 1, '2024-10-05', (1 - 0) * 100000), -- Internet
(20, 1, 2, '2024-10-05', (1 - 0) * 50000),  -- Rác
(21, 2, 1, '2024-10-20', (1 - 0) * 100000), -- Internet
(22, 2, 2, '2024-10-20', (1 - 0) * 50000),  -- Rác
(23, 3, 1, '2024-10-25', (1 - 0) * 100000), -- Internet
(24, 3, 2, '2024-10-25', (1 - 0) * 50000),  -- Rác
(25, 4, 1, '2024-10-30', (1 - 0) * 100000), -- Internet
(26, 4, 3, '2024-10-30', (1 - 0) * 200000), -- Giữ Xe
(27, 5, 1, '2024-10-29', (1 - 0) * 100000), -- Internet
(28, 5, 2, '2024-10-29', (1 - 0) * 50000),  -- Rác
(29, 6, 1, '2024-10-27', (1 - 0) * 100000), -- Internet
(30, 6, 3, '2024-10-27', (1 - 0) * 200000), -- Giữ Xe
(31, 7, 1, '2024-10-28', (1 - 0) * 100000), -- Internet
(32, 7, 2, '2024-10-28', (1 - 0) * 50000),  -- Rác
(33, 8, 1, '2024-10-26', (1 - 0) * 100000), -- Internet
(34, 8, 3, '2024-10-26', (1 - 0) * 200000), -- Giữ Xe
(35, 9, 1, '2024-10-25', (1 - 0) * 100000), -- Internet
(36, 9, 2, '2024-10-25', (1 - 0) * 50000);  -- Rác
